 ...
 * @param[in] myck
 */
template <typename PG> void chk_degenerate2_int(const PG& myck) {
    using Point = typename PG::point_t;
    // using Line = typename PG::line_t;
    using K = Value_type<Point>;
 ...
 * @param[in] myck
 */
template <typename PG> void chk_degenerate2_float(const PG& myck) {
    using Point = typename PG::point_t;
    // using Line = typename PG::line_t;
    using K = Value_type<Point>;
